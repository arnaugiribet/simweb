...
successionsV1ModuleUI <- function(id) {
  ns <- NS(id)
  ...
  #Disseny
  tagList(
    card_header('Simulador de Successions - versió 1') %>% h2,
    card_body(
      tabsetPanel(
        id = ns("tabs1"),
        type = c("tabs"),
        ...
        nav_panel(title = "Simulador",
                  ...
                  column(8,
                         ...
                         box(
                           ...
                           column(12,
                           strong("Introdueix el valor de l'herència (béns del causant)."),
                           currencyInput(
                             ns("valorBens"),
                             "",
                             value = 0,
                           ...
                           column(7,
                                  strong("Dins de l'herència hi ha l'habitatge habitual?"),
                                  selectInput(
                           ...
                           column(7,
                                  strong("Dins de l'herència hi ha béns i drets afectes a activitats econòmiques?"),
                                  selectInput(
                           ...
                           column(7,
                                  strong("Quin és el teu percentatge de participació en l'herència?"),
                                  currencyInput(
                                    ns("pctParticipacio"),
                                    "",
                                    value = 1,
                           ...
                           column(12,
                                  paste0("Es considera que aquest percentatge s'aplica a tots els béns de l'herència"),
                                  br(),
                                  br(),
...
successionsV1ModuleServer <- function(id) {
  moduleServer(
    id,
    function(input,output,session){
      ...
      iv$add_rule("pctParticipacio",sv_required(message = "Cal introduir un número entre 0 i 100.")) #quan no hi ha valor
      iv$add_rule("pctParticipacio",sv_between(0, 1, inclusive = c(T, T), "Cal introduir un número entre 0 i 100.")) 
